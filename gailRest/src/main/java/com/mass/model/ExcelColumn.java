...
public class ExcelColumn {
	...
	public String toString() {
		return "ExcelColumn [SAP_ID=" + SAP_ID + ", REGION=" + REGION + ", MAINT_BASE=" + MAINT_BASE
				+ ", CONSUMER_NAME=" + CONSUMER_NAME + ", PROCESS_FLUID=" + PROCESS_FLUID + ", TYPE=" + TYPE
				+ ", DESIGN_CAPACITY=" + DESIGN_CAPACITY + ", AVG_PRESSURE=" + AVG_PRESSURE + ", AVG_TEMP=" + AVG_TEMP
				+ ", AVG_DAILY_CONSUMPTION=" + AVG_DAILY_CONSUMPTION + ", NO_OF_STREAM=" + NO_OF_STREAM
				+ ", MM_REMARKS=" + MM_REMARKS + ", CONFIGURATION=" + CONFIGURATION + ", CREATED_BY=" + CREATED_BY
				+ ", METERING_TYPE=" + METERING_TYPE + ", CONNECTIVITY=" + CONNECTIVITY + ", STREAM_INDEX="
				+ STREAM_INDEX + ", MET_ID=" + MET_ID + ", PRIMARY_MAKE=" + PRIMARY_MAKE + ", PRIMARY_MODEL="
				+ PRIMARY_MODEL + ", PRIMARY_TAG_NO=" + PRIMARY_TAG_NO + ", PRIMARY_SERIAL_NO=" + PRIMARY_SERIAL_NO
				+ ", PRIMARY_METER_SIZE=" + PRIMARY_METER_SIZE + ", PRIMARY_PRESSURE_CLASS=" + PRIMARY_PRESSURE_CLASS
				+ ", PRIMARY_G_RATING=" + PRIMARY_G_RATING + ", PRIMARY_Q_MAX=" + PRIMARY_Q_MAX + ", PRIMARY_Q_MIN="
				+ PRIMARY_Q_MIN + ", PRIMARY_ORIFICE_DIA=" + PRIMARY_ORIFICE_DIA + ", PRIMARY_TUBE_DIAMETER="
				+ PRIMARY_TUBE_DIAMETER + ", KFACTOR=" + KFACTOR + ", PRIMARY_CREATED_AT=" + PRIMARY_CREATED_AT
				+ ", ORIFICE_LD_CALIBRATION=" + ORIFICE_LD_CALIBRATION + ", ORIFICE_ND_CALIBRATION="
				+ ORIFICE_ND_CALIBRATION + ", ORIFICE_CALIBRATION_AGENCY=" + ORIFICE_CALIBRATION_AGENCY
				+ ", ORIFICE_LD_METER_INTERNAL_INSP=" + ORIFICE_LD_METER_INTERNAL_INSP
				+ ", ORIFICE_ND_METER_INTERNAL_INSP=" + ORIFICE_ND_METER_INTERNAL_INSP
				+ ", ORIFICE_INSP_DATA_UPDATE_IN_FC=" + ORIFICE_INSP_DATA_UPDATE_IN_FC + ", ORIFICE_CREATED_AT="
				+ ORIFICE_CREATED_AT + ", TR_LD_CALIBRATION=" + TR_LD_CALIBRATION + ", TR_ND_CALIBRATION="
				+ TR_ND_CALIBRATION + ", TR_CALIBRATION_AGENCY=" + TR_CALIBRATION_AGENCY + ", TR_LD_ERROR_UPDATION="
				+ TR_LD_ERROR_UPDATION + ", TR_LD_METER_INTERNAL_INSP=" + TR_LD_METER_INTERNAL_INSP
				+ ", TR_ND_METER_INTERNAL_INSP=" + TR_ND_METER_INTERNAL_INSP + ", TR_LD_METERTUBE_INSPECTION="
				+ TR_LD_METERTUBE_INSPECTION + ", TR_ND_METERTUBE_INSPECTION=" + TR_ND_METERTUBE_INSPECTION
				+ ", TR_CREATED_AT=" + TR_CREATED_AT + ", USM_LD_CALIBRATION=" + USM_LD_CALIBRATION
				+ ", USM_ND_CALIBRATION=" + USM_ND_CALIBRATION + ", USM_CALIBRATION_AGENCY=" + USM_CALIBRATION_AGENCY
				+ ", USM_LD_ERROR_UPDATION=" + USM_LD_ERROR_UPDATION + ", USM_LD_METER_INTERNAL_INSP="
				+ USM_LD_METER_INTERNAL_INSP + ", USM_ND_METER_INTERNAL_INSP=" + USM_ND_METER_INTERNAL_INSP
				+ ", USM_LD_METERTUBE_INSPECTION=" + USM_LD_METERTUBE_INSPECTION + ", USM_ND_METERTUBE_INSPECTION="
				+ USM_ND_METERTUBE_INSPECTION + ", USM_LD_HEALTH_MONITORING=" + USM_LD_HEALTH_MONITORING
				+ ", USM_ND_HEALTH_MONITORING=" + USM_ND_HEALTH_MONITORING + ", USM_LD_SOS_VERIFICATION="
				+ USM_LD_SOS_VERIFICATION + ", USM_ND_SOS_VERIFICATION=" + USM_ND_SOS_VERIFICATION
				+ ", USM_STREAM_CONFIGURED=" + USM_STREAM_CONFIGURED + ", USM_OP_CUST_TRAN_INVOICE="
				+ USM_OP_CUST_TRAN_INVOICE + ", USM_CREATED_AT=" + USM_CREATED_AT + ", CORIOLIS_LD_CALIBRATION="
				+ CORIOLIS_LD_CALIBRATION + ", CORIOLIS_ND_CALIBRATION=" + CORIOLIS_ND_CALIBRATION
				+ ", CORIOLIS_CALIBRATION_AGENCY=" + CORIOLIS_CALIBRATION_AGENCY + ", CORIOLIS_CALI_UPDATE_IN_METER="
				+ CORIOLIS_CALI_UPDATE_IN_METER + ", CORIOLIS_LD_METER_TUBE_INSP=" + CORIOLIS_LD_METER_TUBE_INSP
				+ ", CORIOLIS_ND_METER_TUBE_INSP=" + CORIOLIS_ND_METER_TUBE_INSP + ", CORIOLIS_CREATED_AT="
				+ CORIOLIS_CREATED_AT + ", FC_MAKE=" + FC_MAKE + ", FC_MODEL=" + FC_MODEL + ", FC_POWER_SOURCE="
				+ FC_POWER_SOURCE + ", BP_CONTRACT_VALUE=" + BP_CONTRACT_VALUE + ", BP_CONTRACT_UNIT="
				+ BP_CONTRACT_UNIT + ", BP_ASCONFIGURED_VALUE=" + BP_ASCONFIGURED_VALUE + ", BP_ASCONFIGURED_UNIT="
				+ BP_ASCONFIGURED_UNIT + ", AP_SOURCE_TYPE=" + AP_SOURCE_TYPE + ", AP_SOURCE=" + AP_SOURCE
				+ ", AP_FREQ_OF_UPDATION=" + AP_FREQ_OF_UPDATION + ", AP_DATA_USED_FOR_UPDATION="
				+ AP_DATA_USED_FOR_UPDATION + ", AP_LD_UPDATION=" + AP_LD_UPDATION + ", AP_ND_UPDATION="
				+ AP_ND_UPDATION + ", AP_PRESENT_VALUE=" + AP_PRESENT_VALUE + ", AP_PRESENT_UNIT=" + AP_PRESENT_UNIT
				+ ", CCM_ASPERCONTRACT=" + CCM_ASPERCONTRACT + ", CCM_ASCONFIGURED=" + CCM_ASCONFIGURED
				+ ", HV_ASPERCONTRACT=" + HV_ASPERCONTRACT + ", HV_ASCONFIGURED=" + HV_ASCONFIGURED + ", FC_TYPE="
				+ FC_TYPE + ", BT_CONTRACT_VALUE=" + BT_CONTRACT_VALUE + ", BT_CONTRACT_UNIT=" + BT_CONTRACT_UNIT
				+ ", BT_ASCONFIG_VALUE=" + BT_ASCONFIG_VALUE + ", BT_ASCONFIG_UNIT=" + BT_ASCONFIG_UNIT
				+ ", AP_FREQ_OF_UPDATION_VAL=" + AP_FREQ_OF_UPDATION_VAL + ", AP_DATA_USED_FOR_UPDATE_VAL="
				+ AP_DATA_USED_FOR_UPDATE_VAL + ", JOINT_CALI_FREQ=" + JOINT_CALI_FREQ + ", LD_CALIBRATION="
				+ LD_CALIBRATION + ", NEXT_CALIBRATION_DATE=" + NEXT_CALIBRATION_DATE + ", PT_TYPE=" + PT_TYPE
				+ ", PT_MAKE=" + PT_MAKE + ", PT_MODEL=" + PT_MODEL + ", PT_ACCURACY=" + PT_ACCURACY + ", DIFF_PT_TYPE="
				+ DIFF_PT_TYPE + ", DIFF_PT_MAKE=" + DIFF_PT_MAKE + ", DIFF_PT_MODEL=" + DIFF_PT_MODEL
				+ ", DIFF_PT_ACCURACY=" + DIFF_PT_ACCURACY + ", TEMP_INP_TO_FC=" + TEMP_INP_TO_FC + ", TEMP_MAKE="
				+ TEMP_MAKE + ", TEMP_MODEL=" + TEMP_MODEL + ", TEMP_ACCURACY=" + TEMP_ACCURACY + ", RTD_TYPE="
				+ RTD_TYPE + ", RTD_CLASS=" + RTD_CLASS + ", RTD_MAKE=" + RTD_MAKE + ", RTD_MODEL=" + RTD_MODEL
				...
				+ ", LD_SIMULATION=" + LD_SIMULATION + ", SECONDARY_CREATED_AT=" + SECONDARY_CREATED_AT
				+ ", GQ_DATASOURCE=" + GQ_DATASOURCE + ", GQ_FREQ=" + GQ_FREQ + ", GQ_DATA_USED=" + GQ_DATA_USED
				+ ", GQ_UPDATE_FREQ=" + GQ_UPDATE_FREQ + ", GQ_UPDATE_METHOD=" + GQ_UPDATE_METHOD + ", LAB_DETAILS="
				+ LAB_DETAILS + ", COMP_COVERED=" + COMP_COVERED + ", VALIDITY_DATE=" + VALIDITY_DATE
				+ ", COMP_COVERED_VALUE=" + COMP_COVERED_VALUE + ", QALITY_DATA_SOURCE_VAL=" + QALITY_DATA_SOURCE_VAL
				+ ", QALITY_DATA_USED_VAL=" + QALITY_DATA_USED_VAL + ", QALITY_DATA_METHOD_VAL="
				+ QALITY_DATA_METHOD_VAL + ", GC_MAKE=" + GC_MAKE + ", GC_MODEL=" + GC_MODEL
				+ ", GC_MEASUREMENT_CAPABILITY=" + GC_MEASUREMENT_CAPABILITY + ", MI_TYPE=" + MI_TYPE + ", MI_MAKE="
				+ MI_MAKE + ", MI_MODEL=" + MI_MODEL + ", MI_LD_CALIBRATION=" + MI_LD_CALIBRATION
				...
				+ FS_MODEL + ", FS_TAG_NO=" + FS_TAG_NO + ", DF_DESIGN_CAPACITY=" + DF_DESIGN_CAPACITY
				+ ", DF_FILTER_SIZE=" + DF_FILTER_SIZE + ", DF_MAKE=" + DF_MAKE + ", DF_MODEL=" + DF_MODEL
				+ ", DF_TAG_NO=" + DF_TAG_NO + ", PCV_P_SIZE=" + PCV_P_SIZE + ", PCV_PRESSURE_RATING="
				+ PCV_PRESSURE_RATING + ", PCV_TYPE=" + PCV_TYPE + ", PCV_MAKE=" + PCV_MAKE + ", PCV_MODEL=" + PCV_MODEL
				+ ", PCV_SETPOINT=" + PCV_SETPOINT + ", PCV_UNIT=" + PCV_UNIT + ", PCV_REM=" + PCV_REM + ", SDV_S_SIZE="
				+ SDV_S_SIZE + ", SDV_PRESSURE_RATING=" + SDV_PRESSURE_RATING + ", SDV_MAKE=" + SDV_MAKE
				+ ", SDV_MODEL=" + SDV_MODEL + ", SDV_SETPOINT=" + SDV_SETPOINT + ", SDV_UNIT=" + SDV_UNIT
				+ ", SDV_REM=" + SDV_REM + ", PSV_C_TYPE=" + PSV_C_TYPE + ", PSV_C_SIZE=" + PSV_C_SIZE
				+ ", PSV_PRESSURE_RATING=" + PSV_PRESSURE_RATING + ", PSV_MAKE=" + PSV_MAKE + ", PSV_MODEL=" + PSV_MODEL
				+ ", PSV_SETPOINT=" + PSV_SETPOINT + ", PSV_UNIT=" + PSV_UNIT + ", PSV_REM=" + PSV_REM
				+ ", PSV_LAST_CALIBRATION=" + PSV_LAST_CALIBRATION + ", PSV_NEXT_CALIBRATION=" + PSV_NEXT_CALIBRATION
				+ ", GI_FLOW_CONTROL_VALVE=" + GI_FLOW_CONTROL_VALVE + ", GI_FIRE_WATER_SYSTEM=" + GI_FIRE_WATER_SYSTEM
				+ ", GI_GAS_DETECTION_SYSTEM=" + GI_GAS_DETECTION_SYSTEM + ", GI_LAST_REVIEW_AUDIT_COMM="
				+ GI_LAST_REVIEW_AUDIT_COMM + ", GI_LAST_REVIEW_REG_COMM=" + GI_LAST_REVIEW_REG_COMM + ", GI_REMARK="
				+ GI_REMARK + ", PT_MAX_ERROR=" + PT_MAX_ERROR + ", PT_MIN_ERROR=" + PT_MIN_ERROR + ", PT_MAX_ALLOW="
				+ PT_MAX_ALLOW + ", PT_MIN_ALLOW=" + PT_MIN_ALLOW + ", TT_MAX_ERROR=" + TT_MAX_ERROR + ", TT_MIN_ERROR="
				+ TT_MIN_ERROR + ", TT_MAX_ALLOW=" + TT_MAX_ALLOW + ", TT_MIN_ALLOW=" + TT_MIN_ALLOW + "]";
	}
